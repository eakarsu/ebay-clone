...
export default function TaxVatComplianceEnginePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/gap-nonai-ebay/tax-vat-compliance-engine', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Tax / VAT compliance engine</h1>
